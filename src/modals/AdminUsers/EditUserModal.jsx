...
import { TextField, Snackbar, Alert, Box, FormControlLabel, Switch } from '@mui/material';
import GenericAdminModal from '../GenericAdminModal';

const EditUserModal = ({ open, setOpen, row, fetchDataGridData}) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setSnackbar({ open: true, message: 'Pomyślnie zaktualizowano dane użytkownika!', severity: 'success' });
            fetchDataGridData();
            handleClose();
        } catch (error) {
            setSnackbar({
